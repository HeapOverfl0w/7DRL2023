class Data {
  ...
  createEnemies() {
    ...
    this.enemies["reaper"] = new Enemy("reaper", 4, 3, 2, 5, false, this.projectiles['swordProjectile'], this.animations["reaper"], this.animations["reaperAttack"], this.animations["reaperDeath"], 0.0, 0.2, -0.2, 0, 0.1, 0);
