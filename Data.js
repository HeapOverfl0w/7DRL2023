class Data {
  ...
  createAnimations() {
    ...
    this.animations['rock'] = new Animation(this.textures['rock'], 33, 46, 1, 0, false);
    ...
    this.animations["goblinAttack"] = new Animation(this.textures["goblinAttack"], 32, 80, 3, 340, false);
    ...
    this.animations["necroAttack"] = new Animation(this.textures["necroAttack"], 63, 67, 4, 500, false);
    ...
    this.animations["reaperAttack"] = new Animation(this.textures["reaperAttack"], 64, 100, 4, 200, false);
  ...
  createBillboards() {
    ...
    this.billboards['rock'] = new Billboard(this.animations['rock'], 0, 0);
  ...
  createProjectiles() {
    ...
    this.projectiles['swordProjectile'] = new Projectile(this.animations['swordProjectile'], 0, 0, 0, 0, 0.5, 5, 1, 2, SLASH);
  ...
  createEnemies() {
    ...
    this.enemies["rat"] = new Enemy("rat", 3, 3, 2, 2, false, this.projectiles["ratPunch"], this.animations["rat"], this.animations["ratAttack"], this.animations["ratDeath"], 0.2, 0.0, 0.2, 0.0, 0, 0);
    this.enemies["gorgon"] = new Enemy2("gorgon", 7, 1.75, 5, 2600, 2, false, this.projectiles["gorgonFire"], this.animations["gorgon"], this.animations["gorgonAttack"], this.animations["gorgonDeath"], 0.1, 0.0, 0.1, 0.0, 0, 0);
    this.enemies["skeleton"] = new Enemy("skeleton", 4, 1.5, 2, 2, false, this.projectiles["punch"], this.animations["skeleton"], this.animations["skeletonAttack"], this.animations["skeletonDeath"], 0.3, 0.3, -0.2, 0.3, 0, 0);
    ...
    this.enemies["goblinShaman"] = new Enemy2("goblinShaman", 6, 2.5, 10, 2000, 6, false, this.projectiles["lightningProjectile"], this.animations["goblinShaman"], this.animations["goblinShamanAttack"], this.animations["goblinShamanDeath"], 0.1, 0.0, 0.1, 0.0, 0, 0);
    this.enemies["reaper"] = new Enemy("reaper", 4, 3.5, 2, 5, false, this.projectiles['swordProjectile'], this.animations["reaper"], this.animations["reaperAttack"], this.animations["reaperDeath"], 0.0, 0.2, -0.2, 0, 0.1, 0);
    ...
    this.enemies["knight"] = new KnightBoss("knight", 20, 3.5, 12, 2500, 20, false, this.projectiles["ogreProjectile"], this.animations["knight"], this.animations["knightAttack"], this.animations["knightDeath"], this.animations["knightPunch"], -0.2, 0.0, 0.2, 0.2, 0, 0);
    this.enemies["knight"].sizeModifier = 1.5;
    this.enemies["necro"] = new NecroBoss("necro", 16, 1.5, 12, 20, false, this.projectiles["lightningProjectile"], this.animations["necro"], this.animations["necroAttack"], this.animations["necroDeath"], 0.2, 0.0, -0.2, 0.25, 0, 0);
    ...
    this.enemies["sandSlime"] = new Enemy2("sandSlime", 4, 1.75, 5, 3000, 2, false, this.projectiles["sandSlimeProjectile"], this.animations["sandSlime"], this.animations["sandSlimeAttack"], this.animations["sandSlimeDeath"], 0.2, 0.2, 0.1, 0.0, 0, 0);
